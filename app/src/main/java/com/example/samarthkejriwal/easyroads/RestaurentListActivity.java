...
public class RestaurentListActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
            ...
            mFusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    ...
                    if (location != null) {
                        ...
                        fetchStores("restaurent");
                      //  fetchStores("hospital");
        ...
        dialog.setTitle("Enable Location")
                ...
                .setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                        ...
                        ActivityCompat.requestPermissions(RestaurentListActivity.this,
                                new String[]{ACCESS_COARSE_LOCATION,ACCESS_FINE_LOCATION},
                                MY_PERMISION_CODE);
